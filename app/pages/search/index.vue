          ...
          <div v-else-if="memberDetails?.data">
            <div class="flex flex-col md:flex-row justify-center items-center gap-6">
              ...
              <div class="flex-1 flex flex-col md:flex-row gap-6 items-center justify-center">
                ...
                <!-- Vertical Separator -->
                <div class="hidden md:block w-px mx-2 self-stretch" :style="{ backgroundColor: textColor, opacity: '0.2' }" />

                <!-- Column 2 - Brothers and Sisters -->
                <div class="flex-1 space-y-4 text-center">
                  <!-- Brothers -->
                  <div v-if="brothers.length > 0">
                    <p class="text-base mb-2" :style="{ color: textColor }">
                      الأخوة
                    </p>
                    <p
                  ...
                  <div v-if="sisters.length > 0">
                    <p class="text-base mb-2 mt-4" :style="{ color: textColor }">
                      الأخوات
                    </p>
                    <p
